...
//         <Collapsible.Root
//           open={isFilterOpen}
//           onOpenChange={() => setIsFilterOpen(!isFilterOpen)}
//           as={GridItem}
//         >
//           <Collapsible.Content>
//         <Grid
...
//                   variant="ghost"
//                 >
//                  {isFilterOpen ? <ChevronLeftIcon /> : <ChevronRightIcon />}
...
//             {/* Products Grid - Adjust columns based on filter state */}
//             <Grid
//               templateColumns={{
//                 base: "1fr",
//                 md: "repeat(2, 1fr)",
//                 lg: isFilterOpen ? "repeat(4, 1fr)" : "repeat(5, 1fr)",
//               }}
//               gap={6}
//             >
//               {filteredProducts.map((product) => (
